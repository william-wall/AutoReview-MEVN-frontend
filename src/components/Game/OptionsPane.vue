  ...
  <form id="optionsForm" @submit.prevent="start">
    ...
    <div>
      <div>
        ...
        Board size:
        <input class="white" type="number" name="width" min="2" max="10" v-model.number="size.horizontal">
        ×
        <input class="white" type="number" name="height" min="2" max="10" v-model.number="size.vertical">
      </div>
